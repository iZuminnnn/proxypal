...
export function ThinkingReasoningSettings(
	props: ThinkingReasoningSettingsProps,
) {
	const { t } = useI18n();
	...
	const [thinkingBudgetCustom, setThinkingBudgetCustom] =
		createSignal(16000);
	const [savingThinkingBudget, setSavingThinkingBudget] =
		createSignal(false);
	...
	const [savingReasoningEffort, setSavingReasoningEffort] =
		createSignal(false);
							...
							<select
								...
								onChange={(e) =>
									setThinkingBudgetMode(
										e.currentTarget
											.value as ThinkingBudgetSettings["mode"],
									)
								}
